//https://v2.jokeapi.dev/joke/Programming?blacklistFlags=religious<Plug>PeepOpenolitical,racist,sexist


const button = document.getElementById('button');
const audioElement = document.getElementById('audio');
const jokeContainer = document.getElementById('jok');
...
function test(joke){
    ...
    VoiceRSS.speech({
                    key: '1666f9bdce4644f48dc2b4b25eab2c45',
                    src: joke,
                    hl: 'en-us',
                    v: 'Linda',
                    r: 0,
